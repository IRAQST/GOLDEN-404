        ...
        for yuzong in id2:
            ...
            if len(nmf)<6:
                if len(frs)<3:
                    ...
                    pwv.append(frs+'qqwweerr')
                    pwv.append(frs+'zzxxccvv')
                    pwv.append(frs+'aassddff')   
                    pwv.append(frs+'ppooiiuu')
                    pwv.append(frs+'mmnnbbvv')
                    pwv.append(frs+'00998877')   
                    pwv.append(frs+'10002000')
                    pwv.append(frs+'qwertqwert')
                    pwv.append(frs+'qwerqwer')   
                    pwv.append(frs+'asdfasdf')
                    pwv.append(frs+'zxcvzxcv')
                    pwv.append(frs+'mnbvmnbv')   
                    pwv.append(frs+'poiupoiu')
            else:
                if len(frs)<3:
                    pwv.append(nmf)
                else:
